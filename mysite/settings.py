...
# ---- WhatsApp (WATI) ----
# Powers the per-invoice WhatsApp reminder button, which sends from the server.
# With these unset there is no other way to send, so the button is shown disabled
# with the reason rather than falling back to anything.
